// Blynk Auth
char auth[] = "vsBftYjEwxJMcEknPkNPBAvs1uIQB_i2"; // Jorge's Phone Autherization Code
...
#define TRIGGER2 38 //left
#define TRIGGER3 44 //right
#define TRIGGER4 30 //front left
#define ECHO1 41 //front
#define ECHO2 39 //left
#define ECHO3 45 //right
#define ECHO4 31 //front left
...
#define POS_LEFT 80  //position of the left servo to be at 90 degrees
#define POS_RIGHT 80  //position of the right servo to be at 90 degrees
#define SERVO1 3  //pin number for left servo
#define SERVO2 2  //pin number for right servo
